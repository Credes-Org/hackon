...
class _LeaderboardScreenState extends State<LeaderboardScreen> {
  ...
  final List<Platform> _platforms = [
    Platform(name: "Codeforces", imagePath: 'assets/images/codeforces.png', key: 'cf'),
    Platform(name: "Leetcode", imagePath: 'assets/images/leetcode.png', key: 'lc'),
    Platform(name: "Github", imagePath: 'assets/images/github.png', key: 'gh')
  ];

  final List<RankProfile> _profiles = [
    RankProfile(key: 'a', name: 'CodeCrafter', imagePath: 'assets/images/rankprofile.png', score: '8000'),
    RankProfile(key: 'b', name: 'ByteWizard', imagePath: 'assets/images/rankprofile.png', score: '10181'),
    RankProfile(key: 'c', name: 'CodeGuru', imagePath: 'assets/images/rankprofile.png', score: '8885'),
    RankProfile(key: 'd', name: 'TechSavvy', imagePath: 'assets/images/rankprofile.png', score: '9826'),
    RankProfile(key: 'e', name: 'AlgoMaster', imagePath: 'assets/images/rankprofile.png', score: '10831'),
    RankProfile(key: 'f', name: 'ScriptNinja', imagePath: 'assets/images/rankprofile.png', score: '11963'),
    RankProfile(key: 'g', name: 'DevSorcerer', imagePath: 'assets/images/rankprofile.png', score: '9653'),
    RankProfile(key: 'h', name: 'PixelPioneer', imagePath: 'assets/images/rankprofile.png', score: '11382'),
    RankProfile(key: 'i', name: 'CyberSmith', imagePath: 'assets/images/rankprofile.png', score: '6290'),
    RankProfile(key: 'j', name: 'AppArchitect', imagePath: 'assets/images/rankprofile.png', score: '12525'),
    RankProfile(key: 'k', name: 'DataDruid', imagePath: 'assets/images/rankprofile.png', score: '12011')
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Leaderboard", style: AppThemes.headlineMedium(color: darkMode?UIColor.whiteDefault:UIColor.blackDefault)),
        centerTitle: true,
        actions: [
          IconButton(
              onPressed: () {},
        ...
        children: [
          ...
          Stack(
            children:[
               Center(
                  child: Padding(
                    padding: EdgeInsets.only(top: mediaQuery.screenHeight * 0.015),
                    child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Row(
                  children: [
                   GestureDetector(
                       onTap: (){_onToggleIconTap(!_toggleIndex);},
                       child: CustomToggleButton(imagePath: 'assets/images/global.png', isSelected: _toggleIndex, leftButton: true)
                   ),
                   SizedBox(width: 1.0,),
                   GestureDetector(
                       onTap: (){_onToggleIconTap(!_toggleIndex);},
                       child: CustomToggleButton(imagePath: 'assets/images/fab.png', isSelected: !_toggleIndex, leftButton: false)),
                  ],
                ),
                  ...
                  children: [
                    ...
                    ListView.builder(
                        ...
                        itemBuilder: (context,index){
                          return CustomRankProfileCard(name: _profiles[index].name, score: _profiles[index].score, imagePath: _profiles[index].imagePath, position: index+1);
                        }),
                  ]
                ),
              ),
